...
const Home = () => {
  ...
  return (
    <div className="w-full h-full py-5 px-5 sm:px-2 space-y-6">
      <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-4">
        <div className="w-full stats shadow-md bg-amber-100">
          ...
          <div className="stat">
            <div className="stat-title text-2xl">Active Users</div>
            <div className="flex items-start justify-start gap-2">
          ...
          <div className="stat">
            <div className="stat-title text-2xl">Overdue Task</div>
            <div className="flex items-start justify-start gap-2">
          ...
          <div className="stat">
            <div className="stat-title text-2xl">Average Completion (days)</div>
            <div className="flex items-start justify-start gap-2">
              <h1 className="stat-value">{data.averageCompletionDays}</h1>
              <ChartNoAxesCombined className={"text-yellow-400 mt-3"} />
            </div>
            <div className="stat-title text-sm">Avg time take to complete task</div>
          </div>
        </div>
        <div>
