...
//   // New state to manage description visibility for each task
...
//       ...prev,
//       [taskId]: !prev[taskId], // Toggle the boolean for the specific task
//     }));
//   };
...
//       setLoading(false);
//       setTasks(res.data);
//       // Initialize showFullDescription state for new tasks
//       const initialDescriptionVisibility = {};
//       res.data.forEach((task) => {
//         initialDescriptionVisibility[task._id] = false;
//       });
//       setShowFullDescription(initialDescriptionVisibility);
//     } catch (error) {
...
//       // Also initialize the description visibility for the new task
//       setShowFullDescription((prev) => ({
//         ...prev,
//         [newTask._id]: false,
//       }));
...
//       // Remove the task's description visibility state as well
//       setShowFullDescription((prev) => {
//         const newState = { ...prev };
//         delete newState[id];
//         return newState;
...
//                   isDescriptionLong && !showFullDescription[task._id]
...
//                           <h2 className="text-2xl text-wrap font-bold text-slate-700">
//                             {task.title}
//                           </h2>
...
//                           </div>
//                         </div>
//                         <p className="text-xl text-wrap font-semibold text-gray-600">
//                           {displayDescription}
//                           {isDescriptionLong && (
//                             <span
...
//                             >
//                               {showFullDescription[task._id] ? " Less" : " More"}
//                             </span>
//                           )}
//                         </p>
//                       </div>
